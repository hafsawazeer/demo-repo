...
// Handle POST requests (add, edit, delete, status update)
...
// Handle GET requests (view, delete)
if (isset($_GET['view'])) {
...
<head>
    ...
    <link rel="stylesheet" href="supervisor_manage.css" />
</head>
<body>
    <!-- Header -->
    <header class="header">
                        ...
                        <?php if (!empty($nutritionists)): ?>
                            <?php foreach ($nutritionists as $index => $nutritionist): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($nutritionist['phone']); ?></td>
                                    <td><?php echo htmlspecialchars($nutritionist['specialization']); ?></td>
                                    <td><?php echo htmlspecialchars($nutritionist['experience_years']); ?> years</td>
                                    <td>
                                    ...
                                    <td class="controls-cell">
                                        <a href="?view=<?php echo $nutritionist['nutritionist_id']; ?>&q=<?php echo urlencode($search); ?>&sort=<?php echo urlencode($sort); ?>" class="link action-btn view-btn">View Details</a>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="add_experience" name="experience_years" min="0" required>
                        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="edit_experience" name="experience_years" min="0" required>
                        </div>
                        <div class="form-group full-width">
    ...
    <!-- View Details Modal -->
    <?php if ($view_nutritionist): ?>
    <div id="viewDetailsModal" class="modal" style="display: flex;">
        <div class="modal-content modal-large">
            <div class="modal-header">
            ...
            <div class="details-container">
                ...
                <div class="details-section">
                    ...
                    <div class="details-grid">
                        <div class="detail-item">
                            ...
                            <span class="detail-value"><?php echo htmlspecialchars($view_nutritionist['name']); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Nutritionist ID:</span>
                            <span class="detail-value">NT<?php echo str_pad($view_nutritionist['nutritionist_id'], 5, '0', STR_PAD_LEFT); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Email:</span>
                            <span class="detail-value"><?php echo htmlspecialchars($view_nutritionist['email']); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Phone:</span>
                            <span class="detail-value"><?php echo htmlspecialchars($view_nutritionist['phone']); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Gender:</span>
                            <span class="detail-value"><?php echo htmlspecialchars($view_nutritionist['gender']); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Date of Birth:</span>
                            <span class="detail-value"><?php echo date('F d, Y', strtotime($view_nutritionist['dob'])); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">NIC:</span>
                            <span class="detail-value"><?php echo htmlspecialchars($view_nutritionist['nic']); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Registration Date:</span>
                            <span class="detail-value"><?php echo date('F d, Y', strtotime($view_nutritionist['created_at'])); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="details-section">
                    ...
                    <div class="details-grid">
                        <div class="detail-item">
                            ...
                            <span class="detail-value"><?php echo htmlspecialchars($view_nutritionist['specialization']); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Experience:</span>
                            <span class="detail-value"><?php echo htmlspecialchars($view_nutritionist['experience_years']); ?> years</span>
                        </div>
                        <div class="detail-item full-width">
                            <span class="detail-label">Certification:</span>
                            <span class="detail-value"><?php echo htmlspecialchars($view_nutritionist['certification'] ?: 'Not provided'); ?></span>
                        </div>
                        <div class="detail-item full-width">
                            <span class="detail-label">Qualifications:</span>
                            <span class="detail-value"><?php echo nl2br(htmlspecialchars($view_nutritionist['qualifications'] ?: 'Not provided')); ?></span>
                        </div>
                    </div>
                </div>
                    ...
                    <?php if (!empty($view_nutritionist['nic_image_path'])): ?>
                        ...
                        <?php if (in_array($fileExt, ['jpg', 'jpeg', 'png'])): ?>
                            <div class="nic-image-container">
                                <img src="<?php echo htmlspecialchars($imagePath); ?>" alt="NIC Image" class="nic-image" />
                                <a href="<?php echo htmlspecialchars($imagePath); ?>" target="_blank" class="btn btn-secondary" style="margin-top: 12px;">
                                    <span class="icon" data-lucide="external-link"></span>
                                    Open in New Tab
                                </a>
                            </div>
                        <?php else: ?>
                            <a href="<?php echo htmlspecialchars($imagePath); ?>" target="_blank" class="btn btn-secondary">
                ...
                <div class="details-section">
                    ...
                    <form method="POST" action="" class="status-form">
                        <input type="hidden" name="nutritionist_id" value="<?php echo $view_nutritionist['nutritionist_id']; ?>">
                        <div class="status-selector">
                            <label>
                                <input type="radio" name="status" value="pending" <?php echo $view_nutritionist['status'] === 'pending' ? 'checked' : ''; ?>>
                                <span class="status-option pending">Pending</span>
                            </label>
                            <label>
                                <input type="radio" name="status" value="active" <?php echo $view_nutritionist['status'] === 'active' ? 'checked' : ''; ?>>
                                <span class="status-option active">Active</span>
                            </label>
                            <label>
                                <input type="radio" name="status" value="inactive" <?php echo $view_nutritionist['status'] === 'inactive' ? 'checked' : ''; ?>>
                                <span class="status-option inactive">Inactive</span>
                            </label>
                        </div>
                        <button type="submit" name="update_status" class="btn btn-primary">
                            <span class="icon" data-lucide="save"></span>
                            Update Status
                        </button>
                    </form>
                </div>
    ...
    <script>
        ...
        function openEditModal(nutritionist) {
            ...
            document.getElementById('edit_phone').value = nutritionist.phone;
            document.getElementById('edit_specialization').value = nutritionist.specialization;
            document.getElementById('edit_experience').value = nutritionist.experience_years;
